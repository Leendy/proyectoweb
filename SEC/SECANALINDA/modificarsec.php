<?php
	...
	, $ciudad, $producto, $tipo, $conexionp, $anuncio, $proyecto, $convenio, $memo, $fenvio, $envioinfo, $acinfo
	, $fechaulact)
	{
		...
		region='".$region."', ciudad='".$ciudad."',producto='".$producto."',tipo='".$tipo."',conexionp='".$conexionp."', 
		anuncio='".$anuncio."',proyecto='".$proyecto."',convenio='".$convenio."',memo='".$memo."',
