...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-01-2024 a las 22:51:47
...
CREATE TABLE `pgj` (
  ...
  `comentarioag` varchar(10000) NOT NULL,
  `fechaconvenio` date NOT NULL,
  `comentarioaj` varchar(10000) NOT NULL  
...
INSERT INTO `pgj` (`id_empresas`, `fecha`, `Nombre`, `pais`, `sector`, `empleos`, `inversion`, `año`, `region`, 
`ciudad`, `producto`, `tipo`, `nearshoring`, `anuncio`, `primerap`, `inaugruacion`, `proyecto`, `convenio`,
 `memo`, `fenvio`, `envioinfo`, `acinfo`, `fechaulact`, `nombrereprel`, `numeroreprel`, `nombrecontacto`, 
 `numerocontacto`, `estimulos`, `claseestimulos`, `comentarioag`, `fechaconvenio`, `comentarioaj`) VALUES
(1, '2023-12-12', 'Alsuper Saltillo', 'México', 'Energías Renovables', 160.00, 9.70, '2024', 'Sureste', 'Saltillo',
 'Supermercado', 'Nuevo', 'Sin evento', 'Sin evento', 'Sin evento', 'Sin evento', 'Diego Escobar', 'Si', 
 'Adriana Soria', '2023-12-12', 'Proceso', '2023-12-12', '2023-12-12', 'Leendy escamilla', '8441619692', 'Leendy escamilla',
  '8441619692', 'si', 'otros', 'se le entrego documentos necesarios ', '2023-12-12', 'se le entrego documentos necesarios ');
